...
class TestFindSignalingCentroid:
    def setup(self):
        ...
        self.centroid_finder = PoseCentroidTracker(
            "all_videos.csv", openpose_path="../../Libraries/repos/openpose"
        )
    ...
    def test_find_centroid_each_singer_video(self):
        folder_name = (
            "Santa Catarina\Inventario Libras\ Inventário Nacional de Libras - Grande Florianópolis "

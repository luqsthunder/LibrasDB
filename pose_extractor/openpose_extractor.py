...
# Windows Import
    if platform == "win32":
        ...
        # (default path is `/usr/local/python` for Ubuntu), you can also access
        # the OpenPose/python module from there. This will install OpenPose and
        # the python library at your desired installation path. Ensure that this
        # is in your python path in order to use it.

...
libras_video = cv.VideoCapture(
    "/home/lucas/Projects/Libras Video DB/db/Inventário+Libras/FLN G1 D1 CONVER Copa2014 v323/v0.mp4"
)
...
final_video = cv.VideoWriter(
    "video_hand_poses.mp4", fourcc, video_fps, (video_width, video_height)
)
